...
import { useDashboardMovieRevenue } from '@/modules/dashboard/repository';
...
const MovieRevenueChart = () => {
    ...
    const { data: revenue } = useDashboardMovieRevenue({
    ...
    const options: ApexOptions = {
        ...
        colors: ['#5E37FF'],
        xaxis: {
            categories: (revenue || []).map((r) => r.movieName),
            labels: {
