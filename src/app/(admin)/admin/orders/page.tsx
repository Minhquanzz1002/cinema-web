...
const OrderPage = () => {
    ...
    const columns = React.useMemo<ColumnDef<BaseOrder>[]>(
        () => [
            ...
            },
            {
                ...
                header: () => <span>Thời gian đặt</span>,
                cell: ({ row }) => (
                    <div className="flex flex-col gap-2">
            ...
            },
            {
                ...
                header: () => <span>Tổng tiền hàng</span>,
                footer: props => props.column.id,
            },
            {
            ...
            },
            {
                ...
                cell: ({row}) => (
                    <div className="inline-flex gap-2 items-center">
                        <Link href={`/admin/orders/${row.original.code}`} type="button" title="Chi tiết" className="text-gray-600 hover:text-gray-800">
                            <FaEye size={18} />
                        </Link>
                    </div>
                ),
    ...
    const handleExportExcel = () => {
        exportToExcel<BaseOrder>(orders, [], 'products.xlsx');
    };
